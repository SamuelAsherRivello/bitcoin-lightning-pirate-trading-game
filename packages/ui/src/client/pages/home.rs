...
pub fn Home() -> Element {
    ...
    rsx! {
        main { class: "page-content lab-page home-page faq-page",
            ...
            section { class: "lab-panel lab-panel--full",
                div { class: "section-heading",
                    span { class: "eyebrow", "Overview" }
                    h2 { "Why this demo exists" }
                }
                p {
            ...
            section { class: "lab-grid lab-grid--two faq-concept-grid",
            ...
            section { class: "lab-panel",
                div { class: "section-heading",
                    span { class: "eyebrow", "FAQ" }
                    h2 { "Which Lightning Operations need a Bitcoin Block?" }
                }
                p {
