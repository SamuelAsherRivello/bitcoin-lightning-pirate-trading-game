...
- [X] T021 Add create_required_nodes wrapper behavior for Bitcoin backend, Game Treasury, `GAME_TAPROOT`, Jack, Bob, and Carol readiness in packages/ui/src/client/services/lightning_server_functions.rs
